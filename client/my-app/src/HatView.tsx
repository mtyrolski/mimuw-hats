...
export class AddHat extends React.Component<HatAddProps> {
    ...
    render() { return(
        ...
        >
            ...
            >
                <Form.Item name="name" label={"hat name"} rules={[{ required: true,  message: 'Name is required' }, {max: 12, message: 'Maximum 12 characters'}]}>
                    <Input/>
                </Form.Item>
    ...
    render() {
        return (
            <div style={{textAlign: "center"}}>
                <Slider defaultValue={20} onChange={this.onSliderChange} min={5} style={{margin: '4em'}}
                    marks={{
                        5: 'small',
                        20: 'medium',
                        50: 'large',
